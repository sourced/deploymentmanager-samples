...
"""This template creates a healthcheck."""
...
def set_if_exists(healthcheck, properties, prop):
    ...
    if prop in properties:
        healthcheck[prop] = properties.get(prop)
...
def generate_config(context):
    ...
    healthcheck_type = properties.get('healthcheckType')
    ...
    healthcheck_properties = {
        'description': properties.get('description',
                                      ''),
        'checkIntervalSec': properties.get('checkIntervalSec'),
        'timeoutSec': properties.get('timeoutSec'),
        'unhealthyThreshold': properties.get('unhealthyThreshold'),
        'healthyThreshold': properties.get('healthyThreshold'),
